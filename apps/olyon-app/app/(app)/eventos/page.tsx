          ...
          <div className="flex flex-col gap-3 rounded-lg border border-gray-200 bg-white px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <svg width="51" height="21" viewBox="0 0 51 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M11.5 16.75C14.2614 16.75 16.5 14.5114 16.5 11.75C16.5 8.98858 14.2614 6.75 11.5 6.75C8.73858 6.75 6.5 8.98858 6.5 11.75C6.5 14.5114 8.73858 16.75 11.5 16.75Z" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
