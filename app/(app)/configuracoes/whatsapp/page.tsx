  ...
  return {
    ...
    details: {
      ...
      accessTokenRead: {
        ...
        present: Boolean(data.connection?.accessToken?.trim()),
        trimmedLength: data.connection?.accessToken?.trim().length ?? 0,
        sha256Prefix: null,
      },
    ...
    <>
      <HeaderPage>
        <div className="flex items-center justify-between">
          <span className="font-normal text-foreground">WhatsApp Meta</span>
        </div>
      </HeaderPage>
      ...
      <div className="w-full max-w-6xl bg-white px-4 py-6 sm:px-6 sm:py-7">
        {loading ? (
          <div className="rounded-3xl border border-dashed border-slate-300 bg-[linear-gradient(135deg,#f8fafc_0%,#ffffff_40%,#eef6ff_100%)] px-5 py-10 text-center text-sm text-slate-600">
            Carregando configuracao tecnica do WhatsApp...
          </div>
        ) : (
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <h2 className="text-xl font-semibold text-slate-950">
                      Conexao da sua loja com a Meta
                    </h2>
                    <p className="mt-1 max-w-3xl text-sm text-slate-600">
                      Esta configuracao define qual credencial tecnica o backend usa
                      para verificar webhook, identificar o numero conectado e
                      habilitar o envio operacional da sua loja.
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-5 grid gap-3 lg:grid-cols-3">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    ...
                    operacionais concluidos para a conexao atual da loja.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white/80 p-4">
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    {data.operational.isReady
                      ? "A conexao esta pronta para uso operacional com a configuracao minima atual."
                      : `${data.operational.blockingIssues.length} pendencia(s) ainda impedem o uso operacional confiavel.`}
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  ...
                  <p className="mt-1 max-w-3xl text-sm text-slate-600">
                    Este teste faz uma chamada real na Graph API usando a conexao
                    salva da loja atual. O resultado abaixo e separado da auditoria
                    operacional local.
                  </p>
                </div>
              ...
              {checkingConnection ? (
                <div className="mt-4 rounded-2xl border border-dashed border-sky-300 bg-sky-50/80 px-4 py-4 text-sm text-sky-800">
                  Consultando a Meta Graph API com o `accessToken` e o
                  `phoneNumberId` salvos para esta loja...
                </div>
              ) : null}
              ...
              {checkResult ? (
                ...
                >
                  ...
                  {checkResult.details.graphError ? (
                    <div className="mt-4 rounded-2xl border border-slate-200 bg-white/80 px-4 py-3 text-sm text-slate-700">
                      <p className="font-medium text-slate-950">Erro retornado pela Meta</p>
                ...
                <div className="mt-4 rounded-2xl border border-dashed border-slate-300 bg-slate-50/80 px-4 py-4 text-sm text-slate-600">
                  Nenhum teste real foi executado ainda para a conexao atual desta
                  loja.
                </div>
              )}
            </section>
              ...
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Validacao minima da configuracao salva em `WhatsAppConnection`.
                  </p>
                </div>
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Resumo tecnico da `WhatsAppConnection` salva para esta loja.
                  </p>
                </div>
              ...
              {data.connection ? (
                <div className="mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-3">
                  ...
                  <ConnectionSummaryItem
                    label="accessToken"
                    value={data.connection.accessToken ? "Token salvo" : "Nao informado"}
                  />
                </div>
              ) : (
                <div className="mt-4 rounded-2xl border border-dashed border-slate-300 bg-slate-50/80 px-4 py-5 text-sm text-slate-600">
                  Nenhuma conexao tecnica cadastrada ainda. Preencha o formulario abaixo
                  para criar a configuracao Meta da sua loja.
                </div>
              )}
            </section>
            ...
            <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
              <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-slate-600">
                    Os campos abaixo sao salvos na `WhatsAppConnection` da loja atual.
                  </p>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <p className="text-sm text-slate-500">
                      O token permanece vinculado apenas a esta loja e nao exposto por
                      `storeId` no client.
                    </p>
                      ...
                      render={({ field }) => (
                        <div className="flex items-center justify-between gap-4">
                          <div className="space-y-1">
                            ...
                            <p className="text-sm text-slate-600">
                              Quando desligada, a conexao fica salva mas deixa de ser
                              usada operacionalmente.
                            </p>
                          </div>
